...
export default defineThemeConfig({
  ...
  footer: {
    ...
    copyright: 'Articles are licensed under <a target="_blank" href="https://creativecommons.org/licenses/by-nc-sa/4.0/">CC BY-NC-SA 4.0</a><br>© <span id="currentYear"></span> Yu Xiaoyu',
  }
